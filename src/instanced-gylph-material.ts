import { MeshBasicMaterial, MeshBasicMaterialParameters, Shader, Texture } from "three";
import { Font } from "./load-font.js";

export class InstancedGlypthMaterial extends MeshBasicMaterial {
  private shader!: Shader;

  constructor(private font: Font<Texture>, parameters: MeshBasicMaterialParameters | undefined) {
    super(parameters);
    ...
    this.onBeforeCompile = (shader) => {
      ...
      shader.fragmentShader = shader.fragmentShader.replace(
        ...
        `#include <map_fragment>
            ...
            diffuseColor.a *= clamp(dist * float(distanceRange) / length(dxdy) + 0.5, 0.0, 1.0);
